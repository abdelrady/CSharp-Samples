        ...
        where T : IComparable<T>
    {
        ...
        public bool Remove(T value)
        {
            ...
            if (current.Right == null)
            {
                ...
                {
                    AssignChildToParent(parent, current, current.Left);
                }
            }
            ...
            else if (current.Right.Left == null)
            {
                ...
                {
                    AssignChildToParent(parent, current, current.Right);
                }
            }
            ...
            else
            {
                ...
                {
                    AssignChildToParent(parent, current, leftmost);
                }
            }
        ...
        private static void AssignChildToParent(BinaryTreeNode<T> parent, BinaryTreeNode<T> current, BinaryTreeNode<T> child)
        {
            int result = parent.CompareTo(current.Value);
            if (result > 0)
            {
                // if parent value is greater than current value
                // make the current child a left child of parent
                parent.Left = child;
            }
            else if (result < 0)
            {
                // if parent value is less than current value
                // make the current child a right child of parent
                parent.Right = child;
            }
        }
